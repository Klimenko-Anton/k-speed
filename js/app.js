...
function initSliders() {
  ...
  if (document.querySelector('.slider-reviews')) { //Указываем класс нужного слайдера
    //Создаем слайдер
    new Swiper('.slider-reviews__slider', { //Указываем класс нужного слайдера
      ...
      */
      ...
      // Кнопки "влево/вправо"
      navigation: {
        prevEl: '.slider-reviews .slider-reviews__arrow--prev',
        nextEl: '.slider-reviews .slider-reviews__arrow--next',
      },
